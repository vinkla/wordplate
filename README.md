...
[![Total Downloads](https://img.shields.io/packagist/dt/wordplate/framework.svg?style=flat)](https://github.com/wordplate/framework)
...
WordPlate support both Laravel's [collections](https://laravel.com/docs/5.3/collections) and [helper methods](https://laravel.com/docs/5.3/helpers#available-methods). This means you can use great debugging methods such as [`dd()`](https://laravel.com/docs/5.3/helpers#method-dd) and string helpers like [`str_contains()`](https://laravel.com/docs/5.3/helpers#method-str-contains).
...
[array_flatten](https://laravel.com/docs/5.3/helpers#method-array-flatten) | [str_contains](https://laravel.com/docs/5.3/helpers#method-str-contains) | [with](https://laravel.com/docs/5.3/helpers#method-with)
